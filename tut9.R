...
abs(sacf_tgarch[,6:ncol(sacf_tgarch)])<0.05
...
# Example T-Garch model

ARMA_TGARCH_est[[adq_idx_arma_tgarch[2]]]
ARMA_TGARCH_est[[adq_idx_arma_tgarch[2]]]@fit$coef['gamma1']
...
# Example
ARMA_GARCHM_est[[10]]
ARMA_GARCHM_est[[10]]@fit$coef
ARMA_GARCHM_est[[10]]@fit$coef['archm']
